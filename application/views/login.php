...
<head>
    ...
    <title>Login | Human Capital Management System</title>
        ...
        <div class="row g-0">
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>
                                    ...
                                    </script>  Develop with <i class="mdi mdi-heart text-danger"></i> by Biro Pengembangan Sistem</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-9 col-lg-8 col-md-7">
                <div class="auth-bg pt-md-5 p-4 d-flex">
                    <div class="bg-overlay" style="background-color: rgb(0 0 0 / 45%)!important"></div>
                    <ul class="bg-bubbles">
                        <li></li>
                        <li></li>
                        <li></li>
